   ...
   >
      <div >
        <img
          ...
          alt="maleta" className="w-[400px] object-cover"
        />
      </div>
      <div >
        <p className="text-gray-700">I'am a bag is a self-assembled shopper from washable kraft paper coming is a set with replaceable handle and screw fastener</p>
      </div>
    </div>
