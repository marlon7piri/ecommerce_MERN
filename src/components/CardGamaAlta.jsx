...
import {gama_alta} from '../components/data/data'
import {FaSpinner} from 'react-icons/fa'
import { BsArrowRight } from "react-icons/bs";
import { DataContext } from './data/DataProvider';
import { motion } from "framer-motion";

export default function CardGamaAlta() {
  const {spinner,isloading} = useContext(DataContext);
      ...
      >
        ...
        >
          ...
          <div className="p-2 ">
            ...
            <div className="flex   justify-center items-center"><BsArrowRight className="text-blue-600"/><a
